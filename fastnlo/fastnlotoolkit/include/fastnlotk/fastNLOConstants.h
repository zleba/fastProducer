...
// Precompiler variables for conditional compilation are generated
// and stored automatically in config.h via AC_DEFINE statements in configure.ac.
// This config file MUST be the very first one to be included with
// #include <config.h>
// Do not define precompiler directives here.
